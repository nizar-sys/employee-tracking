        ...
        <div class="card">
            ...
            <div class="card-header border-bottom">
                <h5 class="card-title mb-0">
                    <span class="fw-normal">Add Attendance</span>
                </h5>
            </div>
            ...
            <div class="card-body">
                <div class="offcanvas-body mx-0 flex-grow-0 h-100 mt-2">
                    ...
                    <form class="attendance pt-0" id="attendanceForm" method="POST"
                        action="{{ route('attendances.store') }}" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="form-floating form-floating-outline mb-5 mt-2">
                                    <input type="date" class="form-control @error('date') is-invalid @enderror"
                                        id="attendance-date" name="date" aria-label="Date" value="{{ old('date') }}" />
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="form-floating form-floating-outline mb-5 mt-2">
                                    <select class="form-select" id="attendance-type" name="attendance_type">
                                        ...
                                        <option value="check_in" @if (old('attendance_type') == 'check_in') selected @endif>Clock In</option>
                                        <option value="check_out" @if (old('attendance_type') == 'check_out') selected @endif>Clock Out</option>
                                    </select>
                            ...
                            <div class="col-sm-12 col-md-6">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="is_late" id="isLateYes" value="yes">
                                    <label class="form-check-label" for="isLateYes">Yes</label>
                                </div>

                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="is_late" checked id="isLateNo" value="no">
