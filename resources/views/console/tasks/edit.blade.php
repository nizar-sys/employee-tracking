        ...
        <div class="card">
            ...
            <div class="card-header border-bottom">
                <h5 class="card-title mb-0">
                    <span class="fw-normal">Edit Task</span>
                </h5>
            </div>
            ...
            <div class="card-body">
                <div class="offcanvas-body mx-0 flex-grow-0 h-100 mt-2">
                    ...
                    <form class="task pt-0" id="taskForm" method="POST" action="{{ route('tasks.update', $task->id) }}"
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="form-floating form-floating-outline mb-5 mt-2">
                                    <input type="date" class="form-control @error('date') is-invalid @enderror"
                                        id="task-date" name="date" aria-label="Date"
                            ...
                            <div class="col-sm-6 col-md-6">
                                <div class="form-floating form-floating-outline mb-5 mt-2">
                                    <input type="text" class="form-control @error('longlat') is-invalid @enderror"
                                        ...
                                        aria-label="Longitude/Latitude" value="{{ old('longlat', $task->longlat) }}" />
                            ...
                            <div class="col-sm-12">
                                <div class="form-floating form-floating-outline mb-5 mt-2">
                                    <textarea class="form-control @error('description') is-invalid @enderror" id="description" placeholder="Description"
                                        name="description" aria-label="Description" cols="30" rows="10">{{ old('description', $task->description) }}</textarea>
                            ...
                            <div class="col-sm-6 col-md-6">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="is_validate_location"
                                        ...
                                        {{ old('is_validate_location', $task->is_validate_location ? 'yes' : 'no') == 'yes' ? 'checked' : '' }}>
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="is_validate_location"
                                        ...
                                        {{ old('is_validate_location', $task->is_validate_location ? 'yes' : 'no') == 'no' ? 'checked' : '' }}>
